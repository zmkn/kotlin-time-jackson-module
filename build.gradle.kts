                ...
                pom {
                    ...
                    licenses {
                        license {
                            ...
                            url.set("https://github.com/zmkn/kotlin-time-jackson-module/blob/master/LICENSE")
                        }
                    }
                    developers {
                        developer {
                    ...
                    scm {
                        connection.set("scm:git:https://github.com/zmkn/kotlin-time-jackson-module.git")
                        developerConnection.set("scm:git:git@github.com:zmkn/kotlin-time-jackson-module.git")
                        url.set("https://github.com/zmkn/kotlin-time-jackson-module")
                    }
                }
            }
...
if (localProperties.getProperty("jreleaser.enable") == "true") {
    ...
    configure<JReleaserExtension> {
        project {
            ...
            // A list of tags.
            tags.addAll(listOf("datetime", "jackson"))
            ...
            links {
                homepage.set("https://github.com/zmkn/kotlin-time-jackson-module")
                documentation.set("https://github.com/zmkn/kotlin-time-jackson-module/wiki")
                license.set("https://github.com/zmkn/kotlin-time-jackson-module/blob/master/LICENSE")
                bugTracker.set("https://github.com/zmkn/kotlin-time-jackson-module/issues")
                donation.set("https://github.com/zmkn/kotlin-time-jackson-module")
            }
        }
        signing {
            ...
            maven {
                github {
                    register("github") {
                        ...
                        url.set("https://maven.pkg.github.com/zmkn/kotlin-time-jackson-module")
